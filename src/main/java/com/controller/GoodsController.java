                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            GoodsEntity goodsEntity = new GoodsEntity();
//                            goodsEntity.setGoodsName(data.get(0));                    //菜品名称 要改的
//                            goodsEntity.setGoodsTypes(Integer.valueOf(data.get(0)));   //菜品类型 要改的
//                            goodsEntity.setGoodsPhoto("");//照片
//                            goodsEntity.setGoodsKucunNumber(Integer.valueOf(data.get(0)));   //菜品库存 要改的
//                            goodsEntity.setGoodsOldMoney(data.get(0));                    //菜品原价 要改的
