...
//                            goodsOrderEntity.setGoodsOrderUuidNumber(data.get(0));                    //取餐码 要改的
//                            goodsOrderEntity.setGoodsId(Integer.valueOf(data.get(0)));   //菜品 要改的
...
//                            goodsOrderEntity.setOrderTypes(Integer.valueOf(data.get(0)));   //就餐类型 要改的
...
//                            goodsOrderEntity.setCreateTime(date);//时间
                        ...
                        if(goodsOrderEntities_goodsOrderUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [取餐码] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer orderTypes = Integer.valueOf(String.valueOf(params.get("orderTypes")));//就餐类型
        ...
        for (Map<String, Object> map : goodss) {
           //取值
            ...
            //赋值订单信息
            goodsOrderEntity.setGoodsOrderUuidNumber(goodsOrderUuidNumber);//取餐码
            goodsOrderEntity.setGoodsId(goodsId);//菜品
            goodsOrderEntity.setYonghuId(userId);//用户
            goodsOrderEntity.setBuyNumber(buyNumber);//购买的数量 ？？？？？？
            goodsOrderEntity.setOrderTypes(orderTypes);//就餐类型 ？？？？？？
