    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="goodsLiuyanText">
                        <el-input type="textarea"  :readonly="ro.goodsLiuyanText" v-model="ruleForm.goodsLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsLiuyanText" label="留言内容" prop="goodsLiuyanText">
