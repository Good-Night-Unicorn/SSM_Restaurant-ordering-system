        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="菜品信息" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" :disabled="ro.goodsId" filterable placeholder="请选择菜品信息" @change="goodsChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品类型" prop="goodsValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取餐码" prop="goodsOrderUuidNumber">
                       <el-input v-model="ruleForm.goodsOrderUuidNumber"
                                 placeholder="取餐码" clearable  :readonly="ro.goodsOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="取餐码" prop="goodsOrderUuidNumber">
                           <el-input v-model="ruleForm.goodsOrderUuidNumber"
                                     placeholder="取餐码" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="就餐类型" prop="orderTypes">
                        <el-select v-model="ruleForm.orderTypes" :disabled="ro.orderTypes" placeholder="请选择就餐类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="就餐类型" prop="orderValue">
                        <el-input v-model="ruleForm.orderValue"
                            placeholder="就餐类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
